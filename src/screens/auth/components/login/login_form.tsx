...
const styles = StyleSheet.create({
  ...
  textInput: {
    ...
    paddingVertical: Platform.OS === 'web' ? theme.spacing.spacing2 : 0,
    textAlignVertical: Platform.OS === 'web' ? 'top' : 'center',
    includeFontPadding: false,
    minHeight: Platform.OS === 'web' ? 40 : 50,
    paddingTop: Platform.OS === 'web' ? theme.spacing.spacing1 : 0,
    paddingBottom: Platform.OS === 'web' ? theme.spacing.spacing1 : 0,
    outlineStyle: 'none', // 웹에서 포커스 아웃라인 제거
    ...(Platform.OS === 'web' && {
      pointerEvents: 'auto' as const,
      zIndex: 1,
      cursor: 'text',
